...
(function(h) {
    ...
    function ob(a) {
        var b = a.oClasses
          ...
          , e = a.oPreviousSearch
          , f = a.aanFeatures
          , g = '<input type="search" class="' + b.sFilterInput + ' input100"/><span class="focus-input100 material-icons"></span>'
          , j = d.sSearch
          , j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g
          , b = h("<div/>", {
            id: !f.f ? c + "_filter" : null,
            "class": b.sFilter
        }).append(h("<label class='wrap-input100 validate-input'/>").append(j))
          , f = function() {
    ...
    function nb(a) {
        ...
        var i = h("<div><label class='selection-2'/></div>").addClass(b.sLength);
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Hiển thị từ thứ _START_ đến _END_ trong tổng số _TOTAL_ mục",
            sInfoEmpty: "Hiển thị từ thứ 0 đến 0 trong tổng số 0 mục",
            sInfoFiltered: "(đã lọc được trong _MAX_ mục)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
