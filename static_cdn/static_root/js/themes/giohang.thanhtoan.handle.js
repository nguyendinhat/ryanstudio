...
(function ($) {   
    $(document).ready(function() {
        ...
        $("#dathang-form").submit(function(e) {
            ...
            var data;
            if (($('input[name=pttt]:radio:checked').val()=="credit")) {
                data = "csrfmiddlewaretoken="+csrftoken+"&hoten="+$("#hoten").val()+"&sdt="+$("#sdt").val()+"&diachi="+$("#diachi").val()+"&tinhthanh="+$("#tinhthanh").val()+"&quanhuyen="+$("#quanhuyen").val()+"&xaphuong="+$('#xaphuong').find(':selected').val()+"&loai_thanhtoan="+$('input[name=pttt]:radio:checked').val()+"&so_the="+$("#sothe").val()+"&hoten_the="+$("#hotenthe").val()+"&ngayhethan="+$("#ngayhethan").val()+"&ccv="+$("#ccv").val()+"&ma_tinhthanh="+tinhthanh;
            } else {
